#
#  Be sure to run `pod spec lint TenzingCore.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/endSly/TenzingCore.git", :tag => "0.0.1" }
  ...
  s.source_files  = 'TenzingCore', 'TenzingCore/**/*.{h,m}'
